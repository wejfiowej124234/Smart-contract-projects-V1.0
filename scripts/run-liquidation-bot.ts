/**
 * P8: Minimal liquidation bot. Deploys pool + liquidation, creates one liquidatable position,
 * then sends liquidationCall. Run: npx hardhat run scripts/run-liquidation-bot.ts
